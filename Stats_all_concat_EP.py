...
stats_all_a = pd.read_csv('/misc/torrey/onarvaez/M-isq/isq/isq04/right_intact/analisis/stats_image_all.csv')
...
Total_axon_a = pd.read_csv('/misc/torrey/onarvaez/M-isq/isq/isq04/right_intact/analisis/total_axon_cat.csv')
...
mean_total_axon_renamed_a.to_csv('/misc/torrey/onarvaez/M-isq/isq/isq04/right_intact/analisis/Total_axon_mean.csv')
...
std_total_axon_renamed_a.to_csv('/misc/torrey/onarvaez/M-isq/isq/isq04/right_intact/analisis/Total_axon_std.csv')
...
print(result_a)
result_a.to_csv('/misc/torrey/onarvaez/M-isq/isq/isq04/right_intact/analisis/stats_all_concat_EP.csv')

#ANOTHER NERVE

stats_all_b = pd.read_csv('/misc/torrey/onarvaez/M-isq/isq/isq04/intact_b/analisis/stats_image_all.csv')
...
Total_axon_b = pd.read_csv('/misc/torrey/onarvaez/M-isq/isq/isq04/intact_b/analisis/total_axon_cat.csv')
...
mean_total_axon_renamed_b.to_csv('/misc/torrey/onarvaez/M-isq/isq/isq04/intact_b/analisis/Total_axon_mean.csv')
...
std_total_axon_renamed_b.to_csv('/misc/torrey/onarvaez/M-isq/isq/isq04/intact_b/analisis/Total_axon_std.csv')
...
print(result_b)
result_b.to_csv('/misc/torrey/onarvaez/M-isq/isq/isq04/intact_b/analisis/stats_all_concat_EP.csv')